...
export default function Home() {
  ...
  const translations = {
    EN: {
      ...
      heroSubtitle: "We skid cracked cheats so you dont.",
      cs2Button: "CS2 Cheats",
      discordButton: "Join Discord",
      gamesTitle: "Cheats For All Your Main Games",
      gamesSubtitle: "Most of our cheats work, some might be outdated, cut the solo dev some slack ok?",
      cs2Description: "Cheats for CS2 that work, gets updated weekly.",
      csgoDescription: "Cheats for CS:GO that still work",
      valorantDescription: "Triggerbot and ESP for Valorant",
      fortniteDescription: "Cheats for fortnite, mainly works on Windows 10",
      skidDescription: "Free source codes and educational projects for learning",
    ...
    RU: {
      ...
      fortniteDescription: "Читы Battle Royale для доминирования Victory Royale",
      skidDescription: "Бесплатные исходные коды и образовательные проекты для обучения",
      viewCheats: "Посмотреть читы",
      viewSources: "Посмотреть исходники",
  ...
  const gameCategories = [
    ...
    },
    {
      ...
      href: "/csgo-cheats",
      icon: <span className="text-white font-bold text-sm">GO</span>,
    },
    {
      name: "Valorant",
    ...
    {
      name: "Fortnite",
      description: t.fortniteDescription,
      href: "/fortnite-cheats",
      icon: <span className="text-white font-bold text-sm">FN</span>,
    },
    {
      name: "Skid Section",
      description: t.skidDescription,
      href: "/skid-section",
      icon: <span className="text-white font-bold text-sm">SRC</span>,
      isSkid: true,
    },
  ]
      ...
      <div className="relative z-10 space-y-16">
          ...
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 relative">
              <span className="bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent relative">
                <span className="animate-sparkle">{t.heroTitle}</span>
              </span>
            </h1>
                ...
                <Card className="bg-black/50 border border-purple-800/30 hover:border-purple-600/50 backdrop-blur-sm h-full transition-all hover:bg-purple-900/10 hover:shadow-lg hover:shadow-purple-600/10">
                  <CardContent className="p-4">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-purple-300 transition-colors">
                      {game.isSkid ? game.name : language === "RU" ? `Читы ${game.name}` : `${game.name} Cheats`}
                    </h3>
                    ...
                    <div className="flex items-center text-purple-400 text-sm font-medium group-hover:text-purple-300">
                      {game.isSkid ? t.viewSources : t.viewCheats} <ChevronRight className="h-3 w-3 ml-1" />
                    </div>
                  </CardContent>
                </Card>
              </Link>
        ...
        <section>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <StatCard number="5" label={t.gamePlatforms} />
            <StatCard number="15+" label={t.differentCheats} />
